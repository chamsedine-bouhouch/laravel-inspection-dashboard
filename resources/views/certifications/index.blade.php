  ...
  <div class="card-body mw-100 p-0 ">
    <div class="table-responsive p-0 mw-100">
      <table class="table mw-100 vw-100">
        ...
        <tbody>
          @foreach ($certifications as $checklist)
          <tr>
            ...
            <td>
              <form action="{{ route('certifications.destroy',$checklist->id) }}" method="Post">

                <a href="{{ route('certifications.edit', $checklist->id) }}" class="btn btn-success">Edit</a>
                @csrf
                @method('DELETE')
