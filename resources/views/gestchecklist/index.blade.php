...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link disabled" href="{{route('checklist.create')}}">Disabled</a>
      </li>
    </ul>
  ...
  <tbody>
   @foreach  ($checklist as $checklist) 
    <tr>
      ...
      <td>  
        <a href="{{ route('checklist.edit', $checklist->id) }}" class="btn btn-success">Edit</a>
        
    </td>
    <td> <a href="{{ route('checklist.destroy', $checklist->id) }}" class="btn btn-danger">delete</a> </td>
